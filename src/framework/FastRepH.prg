...
{  strcpy(opt, "197121014018125168155005045195228050140231004188239138150025234195160239151160212157042250055134041009085000127106186155096028");
...
CLASS frReportManager
   Hidden:
     VAR _InitSyst, _FrNotifyError, _CloseSyst, _SetIcon, _SetTitle, _SetVisualActions,;
          ...
          _AddReport, _SelectReport, _RemoveReport, _ClearReports
...
METHOD SetTitle(cTitle) class frReportManager
   aCaracteresRemov:={'/','\',':','*','?','"','<','>','|'}
   For nIndice:= 1 to Len(aCaracteresRemov)
		cTitle:= StrTran(cTitle,aCaracteresRemov[nIndice],'')
	Next
...
METHOD SetFileName(cFileName) class frReportManager
   aCaracteresRemov:={'/','\',':','*','?','"','<','>','|'}
   For nIndice:= 1 to Len(aCaracteresRemov)
		cFileName:= StrTran(cFileName,aCaracteresRemov[nIndice],'')
	Next
